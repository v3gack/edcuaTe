...
<<<<<<< Updated upstream
                 <h1 className={styles.tituloSL2}>TEMA DIVISION - LECCION 1</h1>
=======
                 <h1 className={styles.tituloSL2}>TEMA DIVISIÓN - LECCIÓN 1</h1>
>>>>>>> Stashed changes
