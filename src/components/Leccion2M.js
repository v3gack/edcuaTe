...
<<<<<<< Updated upstream
                 <h1 className={styles.tituloSL2}>TEMA MULTIPLICACION - LECCION 2</h1>
=======
                 <h1 className={styles.tituloSL2}>TEMA MULTIPLICACIÓN - LECCION 2</h1>
>>>>>>> Stashed changes
